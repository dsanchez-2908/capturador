...
public class dControlCalidad
{
	...
	public static void actualizarUltimaCarpeta(eUsuario pUsuarioLogueado, int pCdProyecto, string pUltimaCarpeta)
	{
	...
	public static void actualizarNombreArchivo(eUsuario pUsuarioLogueado, int pCdLote, string pArchivos)
	{
		...
		oCom.Parameters.Add("@p_dsNombreArchivo", SqlDbType.VarChar).Value = pArchivos;
		oCom.Parameters.Add("@p_nuCantidadPaginasInicial", SqlDbType.Int).Value = 0;
		try
		{
