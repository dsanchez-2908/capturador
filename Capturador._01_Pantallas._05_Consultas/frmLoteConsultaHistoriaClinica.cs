...
public class frmLoteConsultaHistoriaClinica : Form
{
	...
	private MaskedTextBox txtFechaIndexadoDesde;

	private MaskedTextBox txtFechaIndexadoHasta;
    ...
    private MaskedTextBox txtFeNacimiento;
    private TextBox txtNombreApellido;
    private Label label1;
    private Button btnCerrarDetalle;

	public frmLoteConsultaHistoriaClinica(eUsuario pUsuario)
	{
		InitializeComponent();
		oUsuarioLogueado = pUsuario;
	}

	private void frmLoteConsultaHistoriaClinica_Load(object sender, EventArgs e)
	{
		cargarListas();
		llenarGrillaResultadoConsulta();
		ConfigurarEventosMaskedTextBox();
	}

	private void ConfigurarEventosMaskedTextBox()
	{
		// Agregar eventos Click a los MaskedTextBox para que reciban el foco correctamente
		txtFechaAltaDesde.Click += MaskedTextBox_Click;
		txtFechaAltaHasta.Click += MaskedTextBox_Click;
		txtFechaIndexadoDesde.Click += MaskedTextBox_Click;
		txtFechaIndexadoHasta.Click += MaskedTextBox_Click;
		txtFeNacimiento.Click += MaskedTextBox_Click;
	}
	...
	private void MaskedTextBox_Click(object sender, EventArgs e)
	{
		...
		{
			mtb.Focus();
			mtb.Select(0, 0); // Colocar el cursor al inicio
		}
	}
	...
	private DataTable ObtenerTablaConsultaLote()
	{
		...
		int cdLote = string.IsNullOrEmpty(txtcdLote.Text) ? 0 : Convert.ToInt32(txtcdLote.Text);
		string nombreLote = txtNombreLote.Text;
		int cdEstadoLote = cbxListaEstados.SelectedIndex != -1 ? Convert.ToInt32(cbxListaEstados.SelectedValue) : 0;

		// Validar Fecha Alta Desde
		DateTime FechaAltaDesde = DateTime.MinValue;
		if (txtFechaAltaDesde.MaskCompleted)
		{
			DateTime.TryParseExact(txtFechaAltaDesde.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out FechaAltaDesde);
		}

		// Validar Fecha Alta Hasta
		DateTime FechaAltaHasta = DateTime.MinValue;
		if (txtFechaAltaHasta.MaskCompleted)
		{
			DateTime.TryParseExact(txtFechaAltaHasta.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out FechaAltaHasta);
		}

		int cdUsuarioIndexacion = cbxListaUsuarios.SelectedIndex != -1 ? Convert.ToInt32(cbxListaUsuarios.SelectedValue) : 0;

		// Validar Fecha Indexado Desde
		DateTime FechaIndexadoDesde = DateTime.MinValue;
		if (txtFechaIndexadoDesde.MaskCompleted)
		{
			DateTime.TryParseExact(txtFechaIndexadoDesde.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out FechaIndexadoDesde);
		}

		// Validar Fecha Indexado Hasta
		DateTime FechaIndexadoHasta = DateTime.MinValue;
		if (txtFechaIndexadoHasta.MaskCompleted)
		{
			DateTime.TryParseExact(txtFechaIndexadoHasta.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out FechaIndexadoHasta);
		}
		...
		if (txtFeNacimiento.MaskCompleted)
		{
			DateTime.TryParseExact(txtFeNacimiento.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture, DateTimeStyles.None, out FechaNacimiento);
		}

		try
		{
			oTableResultadoConsulta = nLotes.obtenerLoteConsultaHistoriaClinica(oUsuarioLogueado,cdLote, nombreLote, cdEstadoLote, FechaAltaDesde, FechaAltaHasta, cdUsuarioIndexacion, FechaIndexadoDesde, FechaIndexadoHasta, HistoriaClinica, DNI, NombreApellido, FechaNacimiento);
		}
		catch (Exception ex)
		{
	...
	private void vaciar()
	{
		...
		txtFechaIndexadoDesde.Clear();
		txtFechaIndexadoHasta.Clear();
	...
	private void InitializeComponent()
	{
            ...
            this.txtcdLote = new System.Windows.Forms.TextBox();
            ...
            this.txtFechaIndexadoDesde = new System.Windows.Forms.MaskedTextBox();
            this.txtFechaIndexadoHasta = new System.Windows.Forms.MaskedTextBox();
            ...
            this.txtFeNacimiento = new System.Windows.Forms.MaskedTextBox();
            ...
            this.label4.Text = "Fecha Alta Lote Desde:";
            // 
            // label5
            // 
            ...
            this.label6.Text = "Usuario Indexado:";
            // 
            // label7
            // 
            ...
            this.label13.Text = "Fecha Indexado Desde:";
            // 
            // txtcdLote
            // 
            this.txtcdLote.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtcdLote.Location = new System.Drawing.Point(184, 18);
            this.txtcdLote.Name = "txtcdLote";
            this.txtcdLote.Size = new System.Drawing.Size(230, 22);
            this.txtcdLote.TabIndex = 17;
            // 
            // txtNombreLote
            // 
            this.txtNombreLote.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.cbxListaUsuarios.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cbxListaUsuarios.FormattingEnabled = true;
            this.cbxListaUsuarios.Location = new System.Drawing.Point(184, 153);
            ...
            this.cbxListaEstados.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.cbxListaEstados.FormattingEnabled = true;
            this.cbxListaEstados.Location = new System.Drawing.Point(184, 84);
            ...
            // txtFechaAltaDesde
            // 
            this.txtFechaAltaDesde.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtFechaAltaDesde.Location = new System.Drawing.Point(184, 120);
            ...
            // txtFechaAltaHasta
            // 
            this.txtFechaAltaHasta.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtFechaAltaHasta.Location = new System.Drawing.Point(337, 120);
            ...
            // txtHistoriaClinica
            // 
            this.txtHistoriaClinica.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtHistoriaClinica.Location = new System.Drawing.Point(674, 18);
            this.txtHistoriaClinica.Name = "txtHistoriaClinica";
            this.txtHistoriaClinica.Size = new System.Drawing.Size(230, 22);
            this.txtHistoriaClinica.TabIndex = 23;
            // 
            // txtDNI
            // 
            this.txtDNI.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtDNI.Location = new System.Drawing.Point(674, 51);
            this.txtDNI.Name = "txtDNI";
            this.txtDNI.Size = new System.Drawing.Size(230, 22);
            this.txtDNI.TabIndex = 24;
            // 
            // txtFechaIndexadoDesde
            // 
            this.txtFechaIndexadoDesde.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtFechaIndexadoDesde.Location = new System.Drawing.Point(184, 190);
            this.txtFechaIndexadoDesde.Mask = "00/00/0000";
            this.txtFechaIndexadoDesde.Name = "txtFechaIndexadoDesde";
            this.txtFechaIndexadoDesde.Size = new System.Drawing.Size(77, 23);
            this.txtFechaIndexadoDesde.TabIndex = 27;
            this.txtFechaIndexadoDesde.ValidatingType = typeof(System.DateTime);
            // 
            // txtFechaIndexadoHasta
            // 
            this.txtFechaIndexadoHasta.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtFechaIndexadoHasta.Location = new System.Drawing.Point(337, 190);
            this.txtFechaIndexadoHasta.Mask = "00/00/0000";
            this.txtFechaIndexadoHasta.Name = "txtFechaIndexadoHasta";
            this.txtFechaIndexadoHasta.Size = new System.Drawing.Size(77, 23);
            this.txtFechaIndexadoHasta.TabIndex = 28;
            this.txtFechaIndexadoHasta.ValidatingType = typeof(System.DateTime);
            // 
            // pnlLotesEncontrados
            // 
            this.pnlLotesEncontrados.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            ...
            // pnlDetalleLote
            // 
            this.pnlDetalleLote.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.pnlDetalleLote.Location = new System.Drawing.Point(1121, 219);
            ...
            this.btnCerrarDetalle.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // 
            // txtDetalleFechaIndexacion
            // 
            this.txtDetalleFechaIndexacion.Anchor = System.Windows.Forms.AnchorStyles.None;
            this.txtDetalleFechaIndexacion.Enabled = false;
            this.txtDetalleFechaIndexacion.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.txtDetalleFechaControlCalidad.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.txtDetalleFechaFinalizacion.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.txtDetalleFechaAlta.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.dgvDetalleLote.BackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(49)))), ((int)(((byte)(66)))), ((int)(((byte)(82)))));
            ...
            dataGridViewCellStyle9.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(77)))), ((int)(((byte)(96)))), ((int)(((byte)(130)))));
            ...
            dataGridViewCellStyle9.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(77)))), ((int)(((byte)(96)))), ((int)(((byte)(130)))));
            dataGridViewCellStyle9.SelectionForeColor = System.Drawing.SystemColors.HighlightText;
            dataGridViewCellStyle9.WrapMode = System.Windows.Forms.DataGridViewTriState.True;
            this.dgvDetalleLote.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle9;
            ...
            this.dgvDetalleLote.DefaultCellStyle = dataGridViewCellStyle10;
            ...
            this.dgvDetalleLote.RowHeadersDefaultCellStyle = dataGridViewCellStyle11;
            ...
            this.dgvDetalleLote.RowsDefaultCellStyle = dataGridViewCellStyle12;
            ...
            this.txtDetalleCantidadDespachos.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.txtDetalleRutaLote.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.cbxDetalleOrigen.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // 
            // cbxDetalleUsuarioDigitalizacion
            // 
            ...
            this.cbxDetalleUsuarioDigitalizacion.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.txtDetalleCdLote.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.cbxDetalleEstado.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.cbxDetalleUsuario.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // 
            // txtDetalleNombreLote
            // 
            this.txtDetalleNombreLote.Anchor = System.Windows.Forms.AnchorStyles.None;
            this.txtDetalleNombreLote.Enabled = false;
            this.txtDetalleNombreLote.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.dgvLotesEncontrados.BackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(49)))), ((int)(((byte)(66)))), ((int)(((byte)(82)))));
            ...
            this.dgvLotesEncontrados.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle13;
            ...
            this.dgvLotesEncontrados.DefaultCellStyle = dataGridViewCellStyle14;
            ...
            this.dgvLotesEncontrados.RowHeadersDefaultCellStyle = dataGridViewCellStyle15;
            ...
            this.dgvLotesEncontrados.RowsDefaultCellStyle = dataGridViewCellStyle16;
            ...
            // btnVerLote
            // 
            this.btnVerLote.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.btnVerLote.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // txtFeNacimiento
            // 
            this.txtFeNacimiento.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtFeNacimiento.Location = new System.Drawing.Point(674, 117);
            this.txtFeNacimiento.Mask = "00/00/0000";
            this.txtFeNacimiento.Name = "txtFeNacimiento";
            this.txtFeNacimiento.Size = new System.Drawing.Size(77, 23);
            this.txtFeNacimiento.TabIndex = 94;
            this.txtFeNacimiento.ValidatingType = typeof(System.DateTime);
            // 
            // txtNombreApellido
            // 
            this.txtNombreApellido.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.txtNombreApellido.Location = new System.Drawing.Point(674, 84);
            this.txtNombreApellido.Name = "txtNombreApellido";
            this.txtNombreApellido.Size = new System.Drawing.Size(230, 22);
            this.txtNombreApellido.TabIndex = 96;
            // 
            // label1
            // 
            ...
            // 
            // frmLoteConsultaHistoriaClinica
            // 
            ...
            this.Controls.Add(this.btnVerLote);
            this.Controls.Add(this.btnCerrar);
            this.Controls.Add(this.btnCancelar);
            this.Controls.Add(this.btnExportar);
            this.Controls.Add(this.btnBuscar);
            this.Controls.Add(this.pnlLotesEncontrados);
            this.Controls.Add(this.txtFechaIndexadoHasta);
            this.Controls.Add(this.txtFechaIndexadoDesde);
            this.Controls.Add(this.txtDNI);
            this.Controls.Add(this.txtHistoriaClinica);
            this.Controls.Add(this.txtFechaAltaHasta);
            this.Controls.Add(this.txtFechaAltaDesde);
            this.Controls.Add(this.cbxListaEstados);
            this.Controls.Add(this.cbxListaUsuarios);
            this.Controls.Add(this.txtNombreLote);
            this.Controls.Add(this.txtcdLote);
            ...
            this.Name = "frmLoteConsultaHistoriaClinica";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Consulta de Lotes";
            this.Load += new System.EventHandler(this.frmLoteConsultaHistoriaClinica_Load);
