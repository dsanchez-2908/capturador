...
public class frmDespachoSeparar_v3 : Form
{
	...
	public frmDespachoSeparar_v3(eUsuario pUsuarioLogueado)
	{
		InitializeComponent();
	...
	private void frmDespachoSeparar_v3_Load(object sender, EventArgs e)
	{
		...
		listaDisponibles = new BindingList<eLote>(nLotes.obtenerLotesDisponibleSeparacion(oUsuarioLogueado, 1));
	...
	private void actualizarLotesDisponibles()
	{
		...
		List<eLote> listaDesdeBD = nLotes.obtenerLotesDisponibleSeparacion(oUsuarioLogueado, 1);
	...
	private void btnProcesarIndices_Click(object sender, EventArgs e)
	{
		...
		foreach (DataGridViewRow row in (IEnumerable)dgvLotesSeleccionados.Rows)
		{
			...
			DataTable tablaTemporal = null;
			try
			{
				tablaTemporal = nArchivos.cargarArchivoIndice2(rutaLote, nombreArchivoIndice);
	...
	private async void buscarSeparadores()
	{
		...
		Label labelTotal = new Label
		{
			Text = $"Total de Separadores: {totalRegistros}",
		...
		pnlSeparadoresEncontrados.SuspendLayout();
		...
		pnlSeparadoresEncontrados.ResumeLayout();
	...
	private void dgv_CellValidating(object sender, DataGridViewCellValidatingEventArgs e)
	{
		if (dgvSeparadoresEncontrados.Columns[e.ColumnIndex].Name == "ValorEncontrado")
		{
			...
			if (!int.TryParse(valorIngresado, out var valorNumerico) || valorNumerico < 1 || valorNumerico > 5)
			{
				MessageBox.Show("El valor ingresado debe ser un número entre 1 y 5.", "Valor no válido", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
				e.Cancel = true;
			}
		}
	}
	...
	private void btnAsignarCodigo_Click_1(object sender, EventArgs e)
	{
		...
		int valorEncontradoValidar = Convert.ToInt32(txtNuevoCodigo.Text);


        if (valorEncontradoValidar < 1 || valorEncontradoValidar > 5)
		{
            MessageBox.Show("El valor ingresado debe estar entre 1 y 5", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            return;
        }
		...
		string nombreArchivo = Path.GetFileNameWithoutExtension(txtArchivoActual.Text);
		foreach (DataGridViewRow fila in (IEnumerable)dgvIndicesEncontrados.Rows)
		{
			if (fila.Cells["Despacho"].Value != null && fila.Cells["Despacho"].Value.ToString().Equals(nombreArchivo, StringComparison.OrdinalIgnoreCase))
			{
		...
		listaActual.Add(new eCodigosBarrasEncontrados_v2
		{
			...
			ValorEncontrado = Convert.ToInt32(nuevoValorEncontrado)
		});
	...
	private void agregarAlArchivo(string pRutaLote, string pNombreLote, string pNombreArchivo, int pNumeroPagina, string pValorEncontrado)
	{
		try
		{
			...
			string rutaCompleta = Path.Combine(carpeta, nombreArchivoTxt);
	...
	{
		int valorMaximoBarra = dgvIndicesEncontrados.Rows.Count + dgvLotesSeleccionados.Rows.Count;
		progressBar2.Minimum = 0;
		progressBar2.Maximum = valorMaximoBarra;
		...
		foreach (DataGridViewRow row in (IEnumerable)dgvIndicesEncontrados.Rows)
		{
			...
			List<eCodigosBarrasEncontrados_v2> listaSeperadores = (dgvSeparadoresEncontrados.DataSource as List<eCodigosBarrasEncontrados_v2>) ?? new List<eCodigosBarrasEncontrados_v2>();
			try
			{
				await procesarDespacho(oDespacho, rutaArchivoPDF, listaSeperadores);
			}
			catch (Exception ex)
			{
		...
		{
			int cdLote = Convert.ToInt32(row2.Cells["cdLote"].Value.ToString());
			row2.Cells["dsNombreLote"].Value.ToString();
			eLote oLote = new eLote
			{
				cdProyecto = 1,
				cdLote = cdLote,
				dsRutaLoteFinal = txtCarpetaSalida.Text
			};
			await finalizarLote(oLote);
			if (progressBar2.Value == valorMaximoBarra)
			{
				progressBar2.Value = valorMaximoBarra;
				progressBar2.Refresh();
			}
			else
			{
	...
	private Task procesarDespacho(eDespacho pDespacho, string pRutaArchivoPDF, List<eCodigosBarrasEncontrados_v2> pListaSeparadores)
	{
	...
	private Task finalizarLote(eLote pLote)
	{
		return Task.Run(delegate
		{
			nLotes.finalizarSeparacion(oUsuarioLogueado, pLote);
		});
	}
	...
	private void frmDespachoSeparar_v3_FormClosing(object sender, FormClosingEventArgs e)
	{
		isDisposing = true;
	...
	private void InitializeComponent()
	{
            ...
            this.pnlVisor.Size = new System.Drawing.Size(1292, 436);
            ...
            this.btnZoom.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // btnArchivoSiguiente
            // 
            this.btnArchivoSiguiente.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.btnArchivoSiguiente.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnArchivoSiguiente.Click += new System.EventHandler(this.btnArchivoSiguiente_Click_1);
            // 
            // btnArchivoAnterior
            // 
            this.btnArchivoAnterior.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.btnArchivoAnterior.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnArchivoAnterior.Click += new System.EventHandler(this.btnArchivoAnterior_Click_1);
            // 
            // btnPaginaSiguiente
            // 
            ...
            this.btnPaginaSiguiente.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnPaginaSiguiente.Click += new System.EventHandler(this.btnPaginaSiguiente_Click_1);
            // 
            // btnPaginaAnterior
            // 
            ...
            this.btnPaginaAnterior.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnPaginaAnterior.Click += new System.EventHandler(this.btnPaginaAnterior_Click_1);
            // 
            // label5
            // 
            ...
            // lboxListaArchivos
            // 
            this.lboxListaArchivos.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.lboxListaArchivos.FormattingEnabled = true;
            this.lboxListaArchivos.ItemHeight = 16;
            this.lboxListaArchivos.Location = new System.Drawing.Point(1377, 156);
            ...
            // pnlAsignarCodigo
            // 
            this.pnlAsignarCodigo.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(32)))), ((int)(((byte)(40)))));
            ...
            this.pnlAsignarCodigo.Size = new System.Drawing.Size(1302, 501);
            this.pnlAsignarCodigo.TabIndex = 8;
            this.pnlAsignarCodigo.Visible = false;
            this.pnlAsignarCodigo.Paint += new System.Windows.Forms.PaintEventHandler(this.pnlAsignarCodigo_Paint);
            // 
            // groupBox1
            // 
            ...
            this.btnAsignarCodigo.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnAsignarCodigo.Click += new System.EventHandler(this.btnAsignarCodigo_Click_1);
            // 
            // btnCancelarAsignar
            // 
            this.btnCancelarAsignar.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
            ...
            this.btnCancelarAsignar.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnCancelarAsignar.Click += new System.EventHandler(this.btnCancelarAsignar_Click_1);
            // 
            // label4
            // 
            ...
            // 
            // txtPaginaSeleccionada
            // 
            this.txtPaginaSeleccionada.Enabled = false;
            this.txtPaginaSeleccionada.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // txtNuevoCodigo
            // 
            this.txtNuevoCodigo.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.gbSeleccionarCarpetaSalida.Location = new System.Drawing.Point(12, 785);
            ...
            this.btnSeleccionarCarpetaSalida.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnSeleccionarCarpetaSalida.Click += new System.EventHandler(this.btnSeleccionarCarpetaSalida_Click_1);
            // 
            // txtCarpetaSalida
            // 
            this.txtCarpetaSalida.BackColor = System.Drawing.Color.DarkGray;
            this.txtCarpetaSalida.Enabled = false;
            this.txtCarpetaSalida.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.dgvTotalLotesEncontrados.BackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(49)))), ((int)(((byte)(66)))), ((int)(((byte)(82)))));
            ...
            this.dgvIndicesEncontrados.BackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(49)))), ((int)(((byte)(66)))), ((int)(((byte)(82)))));
            ...
            this.dgvIndicesEncontrados.Location = new System.Drawing.Point(1456, 60);
            ...
            this.dgvSeparadoresEncontrados.BackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(49)))), ((int)(((byte)(66)))), ((int)(((byte)(82)))));
            ...
            this.btnCancelar.Location = new System.Drawing.Point(1231, 13);
            ...
            this.btnCerrar.Location = new System.Drawing.Point(1231, 55);
            ...
            this.btnSeleccionarTodo.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnDeseleccionarTodo.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnAgregarLotes.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnQuitarLotes.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.btnQuitarLotes.Click += new System.EventHandler(this.btnQuitarLotes_Click);
            // 
            // pnlLotesSeleccionados
            // 
            this.pnlLotesSeleccionados.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(32)))), ((int)(((byte)(40)))));
            ...
            this.dgvLotesSeleccionados.BackgroundColor = System.Drawing.Color.FromArgb(((int)(((byte)(49)))), ((int)(((byte)(66)))), ((int)(((byte)(82)))));
            ...
            dataGridViewCellStyle17.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(77)))), ((int)(((byte)(96)))), ((int)(((byte)(130)))));
            ...
            dataGridViewCellStyle17.SelectionBackColor = System.Drawing.Color.FromArgb(((int)(((byte)(77)))), ((int)(((byte)(96)))), ((int)(((byte)(130)))));
            ...
            this.btnProcesarIndices.Font = new System.Drawing.Font("Century Gothic", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            // 
            // pnlSeparadoresEncontrados
            // 
            this.pnlSeparadoresEncontrados.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(26)))), ((int)(((byte)(32)))), ((int)(((byte)(40)))));
            ...
            this.pnlSeparadoresEncontrados.Size = new System.Drawing.Size(361, 501);
            this.pnlSeparadoresEncontrados.TabIndex = 60;
            // 
            // progressBar2
            // 
            this.progressBar2.Location = new System.Drawing.Point(12, 849);
            this.progressBar2.Name = "progressBar2";
            this.progressBar2.Size = new System.Drawing.Size(1660, 30);
            this.progressBar2.TabIndex = 62;
            // 
            // frmDespachoSeparar_v3
            // 
            ...
            this.Controls.Add(this.pnlSeparadoresEncontrados);
            this.Controls.Add(this.btnProcesarIndices);
            this.Controls.Add(this.pnlLotesSeleccionados);
            this.Controls.Add(this.btnQuitarLotes);
            ...
            this.Controls.Add(this.dgvIndicesEncontrados);
            this.Controls.Add(this.dgvTotalLotesEncontrados);
            this.Controls.Add(this.progressBar1);
            this.Controls.Add(this.gbSeleccionarCarpetaSalida);
            this.Controls.Add(this.pnlAsignarCodigo);
            this.Controls.Add(this.lboxListaArchivos);
            this.Controls.Add(this.gbBotonesNavegacion);
            this.Controls.Add(this.pnlVisor);
            this.Name = "frmDespachoSeparar_v3";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Procesar Despachos";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmDespachoSeparar_v3_FormClosing);
            this.Load += new System.EventHandler(this.frmDespachoSeparar_v3_Load);
